...
<xsl:stylesheet version="1.0"
  ...
  <!-- The import below should NOT appear here and is being commented out.  It already appears in foxmlToSolr.xslt and loading it more than once causes unexpected issues with Solr! 
  <xsl:import href="/usr/local/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/RELS-EXT_to_solr.xslt"/>     MAM 28-Mar-2019 -->
